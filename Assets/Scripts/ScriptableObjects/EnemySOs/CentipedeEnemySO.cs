...
public class CentipedeEnemySO : ScriptableObject {
    ...
    [Tooltip("The time between each missile firing AFTER the entire centipede has fired missiles.")]
    ...
    [Tooltip("The length of the time the missile door stays open right BEFORE firing the missile.\nDoes not affect MissileFireDelay.")]
    public float MissileDoorWaitOpenTime = 0.2f;
