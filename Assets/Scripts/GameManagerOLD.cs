...
class ProgrammerPreferences {
    ...
    internal void SetPreferencesAwake() {
        ...
        GameManagerOLD.Instance.plrInvincible = PlayerInvincible;
        GameManagerOLD.Instance.plrNoFuelCost = PlayerNoFuelCost;
        if (StartRound < 1) {
            Debug.LogWarning(
        ...
        GameManagerOLD.Instance.StartRound = StartRound;
    }
    ...
    internal void SetPreferencesStart() {
        ...
        GameManagerOLD.Instance.CurrentMouseSensitivity = Mathf.Clamp(MouseSensitivity, lowSens, highSens);
        ...
        GameManagerOLD.Instance.Audio2D.SetMasterVolume(MasterVolume);
        GameManagerOLD.Instance.Audio2D.SetMusicVolume(EnableMusic ? 100 : 0);
    }
